<template>
  <div class="">
    <footer class=" bg-gray-900/60">
      <div id="get-custom-shevron" class="mx-auto max-w-screen-lg text-center py-16">
        ...
        <p class="my-6 text-gray-400 dark:text-gray-400">Мы изготовим шеврон по вашему дизайну. Для этого заполните форму ниже и мы с вами свяжемся!</p>
        ...
        <div class="">
          <button class="bg-gray-500 px-24 py-2 rounded-3xl">Отправить</button>
        </div>
      </div>
